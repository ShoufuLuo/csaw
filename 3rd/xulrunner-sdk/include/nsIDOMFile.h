/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-m-rel-xr-osx64-bld/build/content/base/public/nsIDOMFile.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozBlobBuilder : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Append(const jsval & data, JSContext* cx) = 0;
...
#define NS_DECL_NSIDOMMOZBLOBBUILDER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Append(const jsval & data, JSContext* cx); 
...
#define NS_FORWARD_NSIDOMMOZBLOBBUILDER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Append(const jsval & data, JSContext* cx) { return _to Append(data, cx); } 
...
#define NS_FORWARD_SAFE_NSIDOMMOZBLOBBUILDER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Append(const jsval & data, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->Append(data, cx); } 
...
/* [implicit_jscontext] void append (in jsval data); */
NS_IMETHODIMP nsDOMMozBlobBuilder::Append(const jsval & data, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
