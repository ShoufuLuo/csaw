/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-m-rel-xr-osx64-bld/build/content/base/public/nsIXMLHttpRequest.idl
 */
...
class NS_SCRIPTABLE nsIXMLHttpRequest : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResponse(JSContext* cx, jsval *aResponse) = 0;
...
#define NS_DECL_NSIXMLHTTPREQUEST \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResponse(JSContext* cx, jsval *aResponse); \
...
#define NS_FORWARD_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResponse(JSContext* cx, jsval *aResponse) { return _to GetResponse(cx, aResponse); } \
...
#define NS_FORWARD_SAFE_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResponse(JSContext* cx, jsval *aResponse) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResponse(cx, aResponse); } \
...
/* [implicit_jscontext] readonly attribute jsval response; */
NS_IMETHODIMP nsXMLHttpRequest::GetResponse(JSContext* cx, jsval *aResponse)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
