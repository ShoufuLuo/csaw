/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-m-rel-xr-osx64-bld/build/js/src/xpconnect/idl/xpccomponents.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPCComponents_Utils : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateObjectIn(const jsval & vobj, JSContext* cx, jsval *_retval NS_OUTPARAM) = 0;

  /* [implicit_jscontext] void makeObjectPropsNormal (in jsval vobj); */
  NS_SCRIPTABLE NS_IMETHOD MakeObjectPropsNormal(const jsval & vobj, JSContext* cx) = 0;
...
#define NS_DECL_NSIXPCCOMPONENTS_UTILS \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateObjectIn(const jsval & vobj, JSContext* cx, jsval *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD MakeObjectPropsNormal(const jsval & vobj, JSContext* cx); 
...
#define NS_FORWARD_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateObjectIn(const jsval & vobj, JSContext* cx, jsval *_retval NS_OUTPARAM) { return _to CreateObjectIn(vobj, cx, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD MakeObjectPropsNormal(const jsval & vobj, JSContext* cx) { return _to MakeObjectPropsNormal(vobj, cx); } 
...
#define NS_FORWARD_SAFE_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateObjectIn(const jsval & vobj, JSContext* cx, jsval *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateObjectIn(vobj, cx, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD MakeObjectPropsNormal(const jsval & vobj, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->MakeObjectPropsNormal(vobj, cx); } 
...
/* [implicit_jscontext] jsval createObjectIn (in jsval vobj); */
NS_IMETHODIMP nsXPCComponents_Utils::CreateObjectIn(const jsval & vobj, JSContext* cx, jsval *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [implicit_jscontext] void makeObjectPropsNormal (in jsval vobj); */
NS_IMETHODIMP nsXPCComponents_Utils::MakeObjectPropsNormal(const jsval & vobj, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
