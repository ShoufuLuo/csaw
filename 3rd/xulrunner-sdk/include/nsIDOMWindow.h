/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-m-rel-xr-osx64-bld/build/dom/interfaces/base/nsIDOMWindow.idl
 */
...
#define NS_IDOMWINDOW_IID_STR "972cb379-6bdc-4544-8b46-8d721e12e906"

#define NS_IDOMWINDOW_IID \
  {0x972cb379, 0x6bdc, 0x4544, \
    { 0x8b, 0x46, 0x8d, 0x72, 0x1e, 0x12, 0xe9, 0x06 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMWindow : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD PostMessageMoz(const jsval & message, const nsAString & targetOrigin, JSContext* cx) = 0;
...
#define NS_DECL_NSIDOMWINDOW \
  ...
  NS_SCRIPTABLE NS_IMETHOD PostMessageMoz(const jsval & message, const nsAString & targetOrigin, JSContext* cx); \
...
#define NS_FORWARD_NSIDOMWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PostMessageMoz(const jsval & message, const nsAString & targetOrigin, JSContext* cx) { return _to PostMessageMoz(message, targetOrigin, cx); } \
...
#define NS_FORWARD_SAFE_NSIDOMWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD PostMessageMoz(const jsval & message, const nsAString & targetOrigin, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->PostMessageMoz(message, targetOrigin, cx); } \
...
/* [binaryname(PostMessageMoz),implicit_jscontext] void postMessage (in jsval message, in DOMString targetOrigin); */
NS_IMETHODIMP nsDOMWindow::PostMessageMoz(const jsval & message, const nsAString & targetOrigin, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
