/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-m-rel-xr-osx64-bld/build/dom/interfaces/canvas/nsIDOMCanvasRenderingContext2D.idl
 */
...
class NS_SCRIPTABLE nsIDOMCanvasRenderingContext2D : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransform(JSContext* cx, jsval *aMozCurrentTransform) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransform(JSContext* cx, const jsval & aMozCurrentTransform) = 0;

  /* [implicit_jscontext] attribute jsval mozCurrentTransformInverse; */
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransformInverse(JSContext* cx, jsval *aMozCurrentTransformInverse) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransformInverse(JSContext* cx, const jsval & aMozCurrentTransformInverse) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozDash(JSContext* cx, jsval *aMozDash) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMozDash(JSContext* cx, const jsval & aMozDash) = 0;
...
#define NS_DECL_NSIDOMCANVASRENDERINGCONTEXT2D \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransform(JSContext* cx, jsval *aMozCurrentTransform); \
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransform(JSContext* cx, const jsval & aMozCurrentTransform); \
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransformInverse(JSContext* cx, jsval *aMozCurrentTransformInverse); \
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransformInverse(JSContext* cx, const jsval & aMozCurrentTransformInverse); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozDash(JSContext* cx, jsval *aMozDash); \
  NS_SCRIPTABLE NS_IMETHOD SetMozDash(JSContext* cx, const jsval & aMozDash); \
...
#define NS_FORWARD_NSIDOMCANVASRENDERINGCONTEXT2D(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransform(JSContext* cx, jsval *aMozCurrentTransform) { return _to GetMozCurrentTransform(cx, aMozCurrentTransform); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransform(JSContext* cx, const jsval & aMozCurrentTransform) { return _to SetMozCurrentTransform(cx, aMozCurrentTransform); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransformInverse(JSContext* cx, jsval *aMozCurrentTransformInverse) { return _to GetMozCurrentTransformInverse(cx, aMozCurrentTransformInverse); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransformInverse(JSContext* cx, const jsval & aMozCurrentTransformInverse) { return _to SetMozCurrentTransformInverse(cx, aMozCurrentTransformInverse); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozDash(JSContext* cx, jsval *aMozDash) { return _to GetMozDash(cx, aMozDash); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozDash(JSContext* cx, const jsval & aMozDash) { return _to SetMozDash(cx, aMozDash); } \
...
#define NS_FORWARD_SAFE_NSIDOMCANVASRENDERINGCONTEXT2D(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransform(JSContext* cx, jsval *aMozCurrentTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozCurrentTransform(cx, aMozCurrentTransform); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransform(JSContext* cx, const jsval & aMozCurrentTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozCurrentTransform(cx, aMozCurrentTransform); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozCurrentTransformInverse(JSContext* cx, jsval *aMozCurrentTransformInverse) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozCurrentTransformInverse(cx, aMozCurrentTransformInverse); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozCurrentTransformInverse(JSContext* cx, const jsval & aMozCurrentTransformInverse) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozCurrentTransformInverse(cx, aMozCurrentTransformInverse); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozDash(JSContext* cx, jsval *aMozDash) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozDash(cx, aMozDash); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozDash(JSContext* cx, const jsval & aMozDash) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozDash(cx, aMozDash); } \
...
/* [implicit_jscontext] attribute jsval mozCurrentTransform; */
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::GetMozCurrentTransform(JSContext* cx, jsval *aMozCurrentTransform)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::SetMozCurrentTransform(JSContext* cx, const jsval & aMozCurrentTransform)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [implicit_jscontext] attribute jsval mozCurrentTransformInverse; */
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::GetMozCurrentTransformInverse(JSContext* cx, jsval *aMozCurrentTransformInverse)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::SetMozCurrentTransformInverse(JSContext* cx, const jsval & aMozCurrentTransformInverse)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [implicit_jscontext] attribute jsval mozDash; */
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::GetMozDash(JSContext* cx, jsval *aMozDash)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::SetMozDash(JSContext* cx, const jsval & aMozDash)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
