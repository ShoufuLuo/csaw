/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-m-rel-xr-osx64-bld/build/content/base/public/nsIDOMFileReader.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMFileReader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResult(JSContext* cx, jsval *aResult) = 0;
...
#define NS_DECL_NSIDOMFILEREADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResult(JSContext* cx, jsval *aResult); \
...
#define NS_FORWARD_NSIDOMFILEREADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResult(JSContext* cx, jsval *aResult) { return _to GetResult(cx, aResult); } \
...
#define NS_FORWARD_SAFE_NSIDOMFILEREADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResult(JSContext* cx, jsval *aResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResult(cx, aResult); } \
...
/* [implicit_jscontext] readonly attribute jsval result; */
NS_IMETHODIMP nsDOMFileReader::GetResult(JSContext* cx, jsval *aResult)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
