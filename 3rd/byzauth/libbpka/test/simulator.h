     ...
     /**
      * manage all the objects needed for running a good simulator trace 
      * this can be thought of as a refactoring of the orignal testprotocol3 
      * the goal is to be able to easily simulate both lazy and non lazy 
      * operations 
      */ 
...
class MailTraceSimulator
{
   static const int MAX_NAME = 1024; 
   static const int KEYBITS = 128;

        /**
         * filtration of mail trace criteria    
         */
   static const int MININCOUNT = 50;
   static const int MINOUTCOUNT = 20;
   static const int TWOWAYCOUNT = 2;
     /**
